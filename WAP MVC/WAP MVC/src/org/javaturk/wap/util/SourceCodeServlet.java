...
@WebServlet(urlPatterns = { "/SourceCodeServlet" }, initParams = {
		@WebInitParam(name = "srcDir", value = "/Users/akin/Java/Eclipse/202009/workspace/Web WS/WAP MVC/src"),
		@WebInitParam(name = "jspDir", value = "/Users/akin/Java/Eclipse/202009/workspace/WEB WS/WAP MVC/WebContent/jsp"),
		@WebInitParam(name = "jsfDir", value = "/Users/akin/Java/Eclipse/202009/workspace/WEB WS/WAP MVC/WebContent/jsf"),
		@WebInitParam(name = "web.xml", value = "/Users/akin/Java/Eclipse/202009/workspace/WEB WS/WAP MVC/WebContent/WEB-INF/web.xml") })
public class SourceCodeServlet extends HttpServlet {

	private String srcDir;
	private String jspDir;
	private String jsfDir;
	...
	public void init(ServletConfig config) throws ServletException {
		...
		jsfDir = (String) config.getInitParameter("jsfDir");
	...
	private String getCode(HttpServletRequest request) {
		...
		try {
			...
			} else { // That's it is either a JSP or a JSF file.
				if (sourceDir.equals("jsf")) { // It's a JSF file.
					filePath = jsfDir + separator + sourceName;
				} else
