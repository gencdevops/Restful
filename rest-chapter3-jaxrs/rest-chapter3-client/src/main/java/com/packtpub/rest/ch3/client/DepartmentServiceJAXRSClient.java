/*
 * Copyright © 2017 Packt Publishing - All Rights Reserved. Unauthorized copying of this file, via
...
public class DepartmentServiceJAXRSClient {
    ...
    private static final Logger logger =
            Logger.getLogger(DepartmentServiceJAXRSClient.class.getName());
    ...
    public static void main(String[] args) {
        ...
        // int count = new DepartmentServiceJAXRSClient().countREST();
        // logger.log(Level.INFO, "Department count " + count);


        // Reads all department resource
        // List<Departments> depts =
        // new DepartmentServiceJAXRSClient().findAll(new GenericType<List<Departments>>() {});
    ...
    public <T> T findRange(Class<T> responseType, String from, String to)
        ...
        WebTarget resource = webTarget;
        resource =
                resource.path(java.text.MessageFormat.format("{0}/{1}", new Object[] {from, to}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
